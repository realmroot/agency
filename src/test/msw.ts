...
// The web suite drives the REAL Enbor RPC client (src/lib/enborrpc, a Hono `hc` RPC client
...
// real — never mock @/lib/enborrpc. Handlers are backed by a small in-memory store so
