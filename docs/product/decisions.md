...
- Runner daemon authentication uses Realmroot device authorization, short-lived Bearer access tokens, rotating refresh credentials, exact audience validation, and least-privilege scopes. Static tokens are unsupported.
