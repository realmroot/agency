...
Use this skill for terminal automation against Enbor. AMA Agent Identity has no
standard protocol today; Realmroot is its current identity provider. AMA's
