 ...
 */
export const createAuthorizationAttempt = <ThrowOnError extends boolean = false>(options: Options<CreateAuthorizationAttemptData, ThrowOnError>): RequestResult<CreateAuthorizationAttemptResponses, CreateAuthorizationAttemptErrors, ThrowOnError> => (options.client ?? client).post<CreateAuthorizationAttemptResponses, CreateAuthorizationAttemptErrors, ThrowOnError>({
 ...
 */
export const deleteCurrentAuthSession = <ThrowOnError extends boolean = false>(options?: Options<DeleteCurrentAuthSessionData, ThrowOnError>): RequestResult<DeleteCurrentAuthSessionResponses, DeleteCurrentAuthSessionErrors, ThrowOnError> => (options?.client ?? client).delete<DeleteCurrentAuthSessionResponses, DeleteCurrentAuthSessionErrors, ThrowOnError>({ url: '/api/v1/auth/sessions/current', ...options });
