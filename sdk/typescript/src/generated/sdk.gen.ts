 ...
 */
export const beginWebLogin = <ThrowOnError extends boolean = false>(options?: Options<BeginWebLoginData, ThrowOnError>): RequestResult<unknown, unknown, ThrowOnError> => (options?.client ?? client).get<unknown, unknown, ThrowOnError>({ url: '/api/v1/auth/login', ...options });

/**
 * Complete confidential web sign-in
 */
export const finishWebLogin = <ThrowOnError extends boolean = false>(options: Options<FinishWebLoginData, ThrowOnError>): RequestResult<unknown, FinishWebLoginErrors, ThrowOnError> => (options.client ?? client).get<unknown, FinishWebLoginErrors, ThrowOnError>({ url: '/api/v1/auth/callback', ...options });

/**
 * End the current web session
 */
export const endCurrentAuthSession = <ThrowOnError extends boolean = false>(options?: Options<EndCurrentAuthSessionData, ThrowOnError>): RequestResult<EndCurrentAuthSessionResponses, EndCurrentAuthSessionErrors, ThrowOnError> => (options?.client ?? client).delete<EndCurrentAuthSessionResponses, EndCurrentAuthSessionErrors, ThrowOnError>({ url: '/api/v1/auth/sessions/current', ...options });
 ...
 */
export const retireAgent = <ThrowOnError extends boolean = false>(options: Options<RetireAgentData, ThrowOnError>): RequestResult<RetireAgentResponses, RetireAgentErrors, ThrowOnError> => (options.client ?? client).delete<RetireAgentResponses, RetireAgentErrors, ThrowOnError>({
 ...
 */
export const createSessionSocketTicket = <ThrowOnError extends boolean = false>(options: Options<CreateSessionSocketTicketData, ThrowOnError>): RequestResult<CreateSessionSocketTicketResponses, CreateSessionSocketTicketErrors, ThrowOnError> => (options.client ?? client).post<CreateSessionSocketTicketResponses, CreateSessionSocketTicketErrors, ThrowOnError>({
