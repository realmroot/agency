 ...
 */
export const createInboxNotification = <ThrowOnError extends boolean = false>(options: Options<CreateInboxNotificationData, ThrowOnError>): RequestResult<CreateInboxNotificationResponses, CreateInboxNotificationErrors, ThrowOnError> => (options.client ?? client).post<CreateInboxNotificationResponses, CreateInboxNotificationErrors, ThrowOnError>({
