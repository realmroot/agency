 ...
 */
export declare const beginWebLogin: <ThrowOnError extends boolean = false>(options?: Options<BeginWebLoginData, ThrowOnError>) => RequestResult<unknown, unknown, ThrowOnError>;
/**
 * Complete confidential web sign-in
 */
export declare const finishWebLogin: <ThrowOnError extends boolean = false>(options: Options<FinishWebLoginData, ThrowOnError>) => RequestResult<unknown, FinishWebLoginErrors, ThrowOnError>;
/**
 * End the current web session
 */
export declare const endCurrentAuthSession: <ThrowOnError extends boolean = false>(options?: Options<EndCurrentAuthSessionData, ThrowOnError>) => RequestResult<EndCurrentAuthSessionResponses, EndCurrentAuthSessionErrors, ThrowOnError>;
/**
 ...
 */
export declare const retireAgent: <ThrowOnError extends boolean = false>(options: Options<RetireAgentData, ThrowOnError>) => RequestResult<RetireAgentResponses, RetireAgentErrors, ThrowOnError>;
/**
 * Read an agent
 */
 ...
 */
export declare const createSessionSocketTicket: <ThrowOnError extends boolean = false>(options: Options<CreateSessionSocketTicketData, ThrowOnError>) => RequestResult<CreateSessionSocketTicketResponses, CreateSessionSocketTicketErrors, ThrowOnError>;
/**
