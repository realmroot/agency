 ...
 */
export declare const createAuthorizationAttempt: <ThrowOnError extends boolean = false>(options: Options<CreateAuthorizationAttemptData, ThrowOnError>) => RequestResult<CreateAuthorizationAttemptResponses, CreateAuthorizationAttemptErrors, ThrowOnError>;
/**
 * Delete the current browser session
 */
export declare const deleteCurrentAuthSession: <ThrowOnError extends boolean = false>(options?: Options<DeleteCurrentAuthSessionData, ThrowOnError>) => RequestResult<DeleteCurrentAuthSessionResponses, DeleteCurrentAuthSessionErrors, ThrowOnError>;
/**
