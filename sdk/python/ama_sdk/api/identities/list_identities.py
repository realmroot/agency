...
from ...models.list_identities_archived import ListIdentitiesArchived
...
def _get_kwargs(
    *,
    archived: ListIdentitiesArchived | Unset = UNSET,
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ErrorResponse | IdentityListResponse | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[ErrorResponse | IdentityListResponse]:
    return Response(
...
) -> Response[ErrorResponse | IdentityListResponse]:
    """ List identities

    Args:
        archived (ListIdentitiesArchived | Unset): Filter by lifecycle. Defaults to false (live
...
def sync(
    *,
...
) -> ErrorResponse | IdentityListResponse | None:
    """ List identities
    ...
    Returns:
        ErrorResponse | IdentityListResponse
     """
