...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@enbor/runtime-contracts': path.resolve(__dirname, './packages/runtime-contracts/src'),
            ...
            return {
              ...
              miniflare: {
                ...
                bindings: {
                  ...
                  VAULT_ENCRYPTION_KEY: 'test-vault-encryption-key-for-workers-suite-32-bytes',
                  WEB_SESSION_ENCRYPTION_KEY: 'test-web-session-encryption-key-for-workers-suite',
                },
                serviceBindings: {
